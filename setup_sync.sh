...
function start_ptp4l {
	...
	#local _command="ptp4l -i $1 -A -2 -m -f /home/intel/linuxptp/configs/gPTP-2020.cfg"
...
function start_phc2sys {
	...
	local _command="phc2sys -s $phc2sys_s -c $phc2sys_c -m -O 0"
	echo $_command
}
...
function usage {
	echo "Usage:"
	echo "./setup_sync.sh [-h] -i interface -b {master|slave} [-d]"
	echo
