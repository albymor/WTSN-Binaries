		...
		struct {
			...
			union {
				...
				struct {
					u8 action_code;
					u8 trigger;
				} __packed timing_measurement_req;
				struct {
					u8 action_code;
					u8 dialog_token;
					u8 followup_dialog_token;
					__le32 tod;
					__le32 toa;
					u8 max_tod_err;
					u8 max_toa_err;
					u8 variable[0];
				} __packed timing_measurement;
				struct {
					u8 action_code;
					u8 dialog_token;
					u8 followup_dialog_token;
...
#endif
					u8 variable[0];
				} __packed tm_msmt_ind;
#endif /* CPTCFG_IWLWIFI_TIMING_MEASUREMENT */
			} u;
		} __packed action;
	} u;
} __packed __aligned(2);
...
#ifdef CPTCFG_IWLWIFI_TIMING_MEASUREMENT
	WLAN_CATEGORY_UNPROTECTED_WNM = WLAN_CATEGORY_WNM_UNPROTECTED,
#endif
...
enum ieee80211_wnm_actioncode {
	...
	WLAN_WNM_ACTION_EVENT_REPORT = 1,
	WLAN_WNM_ACTION_DIAGNOSTIC_REQ = 2,
	WLAN_WNM_ACTION_DIAGNOSTIC_REPORT = 3,
	WLAN_WNM_ACTION_LOCATION_CFG_REQ = 4,
	WLAN_WNM_ACTION_LOCATION_CFG_RESP = 5,
	WLAN_WNM_ACTION_BSS_TRANS_MGMT_QUERY = 6,
	WLAN_WNM_ACTION_BSS_TRANS_MGMT_REQ = 7,
	WLAN_WNM_ACTION_BSS_TRANS_MGMT_RESP = 8,
	WLAN_WNM_ACTION_FMS_REQ = 9,
	WLAN_WNM_ACTION_FMS_RESP = 10,
	WLAN_WNM_ACTION_COLLOCATED_INTERFERENCE_REQ = 11,
	WLAN_WNM_ACTION_COLLOCATED_INTERFERENCE_REPORT = 12,
	WLAN_WNM_ACTION_TFS_REQ = 13,
	WLAN_WNM_ACTION_TFS_RESP = 14,
	WLAN_WNM_ACTION_TFS_NOTIFY = 15,
	WLAN_WNM_ACTION_SLEEP_MODE_REQ = 16,
	WLAN_WNM_ACTION_SLEEP_MODE_RESP = 17,
	WLAN_WNM_ACTION_TIM_BROADCAST_REQ = 18,
	WLAN_WNM_ACTION_TIM_BROADCAST_RESP = 19,
	WLAN_WNM_ACTION_QOS_TRAFFIC_CAPAB_UPDATE = 20,
	WLAN_WNM_ACTION_CHANNEL_USAGE_REQ = 21,
	WLAN_WNM_ACTION_CHANNEL_USAGE_RESP = 22,
	WLAN_WNM_ACTION_DMS_REQ = 23,
	WLAN_WNM_ACTION_DMS_RESP = 24,
	WLAN_WNM_ACTION_TIMING_MEASUREMENT_REQ = 25,
	WLAN_WNM_ACTION_NOTIFICATION_REQ = 26,
	WLAN_WNM_ACTION_NOTIFICATION_RESP = 27,
};

/* Unprotected WNM action codes */
enum ieee80211_unprotected_wnm_actioncode {
	WLAN_UNPROTECTED_WNM_ACTION_TIM = 0,
	WLAN_UNPROTECTED_WNM_ACTION_TIMING_MEASUREMENT = 1,
};

#ifdef CPTCFG_IWLWIFI_TIMING_MEASUREMENT
/* Timing Measurment Capability defined in bit 7 of 3rd byte of the  
* @WLAN_EID_EXT_CAPABILITY information element
*/
#define WLAN_EXT_CAPA3_TIMING_MSMT BIT(7)
#endif /* CPTCFG_IWLWIFI_TIMING_MEASUREMENT */
...
#ifdef CPTCFG_IWLWIFI_TIMING_MEASUREMENT
/**
 * ieee80211_is_timing_msmt_req - check if frame is a timing measurement request 
 * action frame
 * @hdr: the frame
 * @len: length of the frame
 */
static inline bool ieee80211_is_timing_msmt_req(struct ieee80211_hdr *hdr,
					      size_t len)
{
	struct ieee80211_mgmt *mgmt = (void *)hdr;
	...
	if (len < IEEE80211_MIN_ACTION_SIZE)
		return false;
	return ((ieee80211_is_action(hdr->frame_control)) && 
...
/**
 * ieee80211_is_timing_msmt_action - check if frame is a timing measurement request 
 * action frame
 * @hdr: the frame
 * @len: length of the frame
 */
static inline bool ieee80211_is_timing_msmt_action(struct ieee80211_hdr *hdr,
					      size_t len)
{
	struct ieee80211_mgmt *mgmt = (void *)hdr;
	...
	if (len < IEEE80211_MIN_ACTION_SIZE)
		return false;
	return ((ieee80211_is_action(hdr->frame_control)) &&
		(mgmt->u.action.category == WLAN_CATEGORY_WNM_UNPROTECTED) &&
		(mgmt->u.action.u.timing_measurement.action_code ==
